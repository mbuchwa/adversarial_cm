...
def ResNet18_embed_y2h(dim_embed=DIM_EMBED, nc=NC):
    return ResNet_embed(BasicBlock, [2,2,2,2], dim_embed=dim_embed, nc=nc)

def ResNet34_embed_y2h(dim_embed=DIM_EMBED, nc=NC):
    return ResNet_embed(BasicBlock, [3,4,6,3], dim_embed=dim_embed, nc=nc)

def ResNet50_embed_y2h(dim_embed=DIM_EMBED, nc=NC):
    return ResNet_embed(Bottleneck, [3,4,6,3], dim_embed=dim_embed, nc=nc)
