...
python main.py \
    ...
    --save_freq 5000 --sample_freq 5000 \
    ...
    --use_ada_vic --ada_vic_type vanilla --min_n_per_vic $MIN_N_PER_VIC --use_symm_vic \
    --use_aux_reg_branch --use_aux_reg_model \
    --aux_reg_loss_type ei_hinge --weight_d_aux_reg_loss 1.0 --weight_g_aux_reg_loss 1.0 \
    --use_dre_reg --dre_head_arch "MLP3" --dre_lambda 1e-2 --weight_d_aux_dre_loss 0.5 --weight_g_aux_dre_loss 0.5 \
    --samp_batch_size 100 --eval_batch_size 100 \
    --do_eval \
